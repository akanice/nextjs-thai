            ...
            <div className="flex mb-9" id="ProgressStepper">
                ...
                <div className="w-1/4 flex justify-center items-center">
                    <div className="relative mr-1">
                        {page.page == 1 ? (
                            <div className="w-6 h-6 mx-auto bg-sky-500 rounded-full text-lg text-white flex items-center">
                                <span className="text-center text-sm text-white w-full">1</span>
                            </div>
                        ) : (
                ...
                <div className="w-1/4 flex justify-center items-center">
                    <div className="relative mr-1">
                        <div className="absolute flex align-center items-center align-middle content-center" style={{ width: '5rem', top: '50%', transform: 'translate(-112%, -50%)' }}>
                        ...
                        {page.page > 2 ? (
                            ...
                            <div className="w-6 h-6 mx-auto bg-sky-500 border border-sky-500 rounded-full text-lg text-white flex items-center">
                                <span className="text-center text-sm w-full" style={{ color: 'white' }}>
                                    2
                                </span>
                            </div>
                        ) : (
                            <div className="w-6 h-6 mx-auto bg-white border border-main-color rounded-full text-lg text-white flex items-center">
                                <span className="text-center text-sm text-main-color w-full">2</span>
                            </div>
                        )}
                    </div>

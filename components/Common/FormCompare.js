        ...
        <>
            <div className={`grid grid-cols-2 gap-4`}>
                ...
                <div className={'flex items-center justify-end'}>
                    ...
                    <FormSelect options={birthDate} name={`name_2`} defaultValue={birthday && birthday[0]} className={`mr-2`} />
                    <FormSelect options={birthMonth} name={`name_2`} defaultValue={birthday && birthday[1]} className={`mr-2`} />
                    <FormSelect options={birthYear} name={`name_2`} defaultValue={birthday && birthday[2]} className={`mr-2`} />
                </div>
            </div>
            <div className={`grid grid-cols-3 gap-4`}>
                ...
                <div className={''}>
                    <FormInput name={`name_7`} label={`Ngày cấp`} placeholder={``} value={data?.issue_date} />
                </div>
                <div className={''}>
            ...
            <div className={`grid grid-cols-3 gap-4`}>
                <div className={''}>
                    <FormInput name={`name_4`} label={`Chức vụ`} placeholder={``} value={`Tổng giám đốc`} />
                </div>

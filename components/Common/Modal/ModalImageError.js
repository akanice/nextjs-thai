...
const ModalImageError = ({name,checked,className}) => {
  ...
  return (
    <>
        <div className={`flex flex-col justify-center`}>
          ...
          <h3 className={`text-center font-bold text-red-500 text-2xl mb-9`}>Chất lượng hình ảnh của hồ sơ quý khách tải lên không đạt yêu cầu</h3>
...
export default ModalImageError;
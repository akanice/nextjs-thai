...
const BriefStep1 = () => {
    ...
    const user = [
        {avatar: '/images/leftcol-avatar.png'},
    ]
        ...
        <>
            <div className={`upload-docs`}>
                ...
                <div className={`flex justify-start items-center mt-6`}>
                    <div className={`text-green-500 mr-3`}><AiFillCheckCircle size={24} /></div>
                    <div>
            ...
            <div className={`grid grid-cols-2 gap-8`}>{/* Row 1 */}
                <div className={''}>
            ...
            <div className={`grid grid-cols-2 gap-8`}>{/* Row 2 */}
                <div className={''}>
            ...
            <div className={`grid grid-cols-2 gap-8`}>{/* Row 3 */}
                <div className={''}>
            ...
            <div className={`grid grid-cols-2 gap-8`}>{/* Row 4 */}
                <div className={''}>
            ...
            <div className={`grid grid-cols-2 gap-8`}>{/* Row 5 */}
                <div className={''}>
